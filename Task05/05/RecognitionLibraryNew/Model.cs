...
namespace RecognitionLibrary
{
    public class PredictionResult
    {
        ...
        public PredictionResult(string path="", string label="", double confidence=0.0)
        {
            this.Path = path;
            this.Label = label;
    ...
    public class Model
    {
        ...
        static CancellationToken _ct;// = new CancellationToken();

        public Model(
            string model_path = "C:/test_mdl/resnet50-v2-7.onnx",
            string img_path = "C:/test_mdl/dog.jpeg",
        ...
        public PredictionResult WorkSingleImg(string str)
        {
            var bytes = Convert.FromBase64String(str);
            string filename = "C:/server_images/processing" + "current" + ".jpeg";
